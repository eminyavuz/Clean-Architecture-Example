...
import com.example.clean_architecture_example.application.usecase.product.ActivateProductUseCase;
...
public class ActivateProductUseCaseTest {
    ...
    @Test
    @DisplayName("Should activate product successfully when product exists")
    void should_activate_product_successfully() {
        Product product = Product.reconstitute(1, "Keyboard", new BigDecimal("50.00"), "Description", 20, false);
