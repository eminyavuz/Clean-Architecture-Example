...
import com.example.clean_architecture_example.application.usecase.product.DeactivateProductUseCase;
...
public class DeactivateProductUseCaseTest {
    ...
    @Test
    @DisplayName("Should deactivate product successfully when product exists")
